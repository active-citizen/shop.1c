    ...
    \section{Карточка товара}
        ...
        \subsection{Склад выдачи}\label{sec:goods_cart_stores} 
            ...
            \begin{enumerate}
                ...
                \item Вместе с характеристиками товара (см.\ref{sec:goods_cart_props}) позволяет указать конкретное \gloss{offer}
                    для приобретения
            \end{enumerate}
        ...
        \subsection{Выбор свойства товара}
            ...
            \begin{enumerate}
                ...
                \item Вместе с выбором склада (см.\ref{sec:goods_cart_stores}) позволяет указать конкретное \gloss{offer}
                    для приобретения
            \end{enumerate}
    ...
    \section{Правила}
        \subsection{Как это работает}
            ...
            \begin{enumerate}
                ...
                \item Раздел заполняется пользователями группы <<\gloss{content_editor}>> в \gloss{CMS}.
            \end{enumerate}
        ...
        \subsection{Адреса}
            ...
            \begin{enumerate}
                ...
                \item Раздел формируется из информации об объектах типа \gloss{storage}, полученных из \gloss{UNF} в результате действия \gloss{import1c}.
                ...
                \item При клике на любую ссылку аккордиона открывается блок с подробной информацией, включающей:
                    \begin{itemize}
                        \item Яндекс-карту с отметкой (карта и отметка формируются 
                            ...
                            \gloss{import1c}, поэтому важно контролировать полноту и корректность этого адреса);
                        \item телефон;
                        \item режим работы;
                        \item адрес сайта;
                    \end{itemize}
        ...
        \subsection{FAQ}
            ...
            \begin{enumerate}
                ...
                \item Раздел формируется из информации, вносимой пользователями группы \gloss{content_editor} в \gloss{CMS}.
