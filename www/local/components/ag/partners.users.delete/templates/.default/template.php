...
<h1>Удаление партнёра или оператора</h1>
<? if($arResult["ERRORS"]):?>
...
<form class="form-horizontal" method="POST">
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <label>
                    <input disabled="yes" type="checkbox" name="GROUPS_ID[<?= 
                    PARTNERS_GROUP_ID
                    ?>]"
        ...
        <tr>
            ...
            <td>
                <label>
                    <input disabled="yes" type="checkbox" name="ALL_STORES"
                ...
                <br/>
                <label>
                    <input disabled="yes" type="checkbox" name="ALL_MANS"
        ...
        <tr>
            ...
            <td>
                <select disabled="yes" name="STORES[]" class="form-control" 
                multiple="multiple" size="12" tabindex="0">
        ...
        <tr>
            ...
            <td>
                <select disabled="yes" name="MANS[]" class="form-control" 
