    ...
    class troykaTest extends PHPUnit_Framework_TestCase{
        ...
        */
        ...
        function testErrorMapping(){
            ...
            $this->assertEquals('"Приносим свои извинения. Удаленное пополнение карты «Тройка» отклонено. Попробуйте повторить Ваш запрос позднее. " (код для обращения в техподдержку 24,6,E004)', $arError["messageText"]);
