 ...
 * Типы документов
 */
class CSearchDocumentOption extends CAGShop
{
    ...
    function getId($sType)
    {
        ...
        if (isset($this->arOptionTypes[$sType])) {
            return $this->arOptionTypes[$sType];
        }
        return false;
    ...
    function fetch($nDocId, $sOptionType = 'PRODUCT')
    {
        ...
        if (isset($arWish[0])) {
            $arOptions["WHISHES"] = [$arWish[0]["COUNT"]];
        }
