 ...
 * Типы документов
 */
class CSearchDocumentType extends CAGShop
{
    ...
    function getId($sType)
    {
        ...
        if (isset($this->arDocTypes[$sType])) {
            return $this->arDocTypes[$sType];
        }
        return false;
    ...
    private function __getUnindexedProducts($sType = 'PRODUCT', $nExpires = 0)
    {
        ...
        if (isset($arNextProduct[0]["count"])) {
            return $arNextProduct[0]["count"];
        }
        return false;
    }
    ...
    private function __nextProduct($sType = 'PRODUCT', $nExpires = 0)
    {
        ...
        ";
        $arNextProduct = $CDB->sqlSelect($sQuery);
        if (isset($arNextProduct[0]["ID"])) {
            return $arNextProduct[0]["ID"];
        }
        return false;
    }
